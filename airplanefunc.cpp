/*
	...
	Descrição: Implementação das funções assinadas no arquivo header (airplanefunc.h).
*/
...
void decreaseFuel() {
	...
	for (Plane *act=dec1.first; act != NULL; act=act->next) act->inf.fuelNow-- ; // "Decrementa" o combustivel do aviao da decolagem apenas para marcar tempo de espera
